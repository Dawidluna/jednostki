...
export default class Unit extends React.Component {
    ...
    render() {
        ...
        switch(this.props.dataType) {
            case "dane":
                select = <select onChange={this.selectUnit}><option value="1">bit</option>
                ...
                break;
            case "masa":
                select = <select onChange={this.selectUnit}><option value="1">miligram</option>
                ...
                break;
            case "czas":
                select = <select onChange={this.selectUnit}><option value="1">sekunda</option>
                ...
                break;
            case "dystans":
                select = <select onChange={this.selectUnit}><option value="1">milimetr</option>
                ...
                break;
            case "powierzchnia":
                select = <select onChange={this.selectUnit}><option value="1">milimetr kwadratowy</option>
                ...
                break;
            case "objętość":
                select = <select onChange={this.selectUnit}><option value="1">mililitr</option>
